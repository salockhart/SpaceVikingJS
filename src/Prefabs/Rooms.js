...
export default [
	[
		...
		null,
		new Room(false, [Items.statues.nisk], null, 'The rear of the ship<br>Large windows allow a view of the stars beyond, while massive nuclear thrusters loom to each side.'),
		new Room(false, [], null, 'The rear of the ship<br>Large windows allow a view of the stars beyond, while massive nuclear thrusters loom to each side.'),
		null,
		new Room(true, [], Enemies.boss, 'The nuclear core is in view. The room is bathed in the green glow of the unshielded core.'),
		null,
		new Room(false, [], null, 'The stern of the ship<br>Large windows allow a view of the stars beyond, while massive nuclear thrusters loom to each side.'),
		new Room(false, [Items.playerWeapons.fiskefrikadeller], null, 'The stern of the ship<br>Large windows allow a view of the stars beyond, while massive nuclear thrusters loom to each side.'),
		null,
	...
	[
		new Room(false, [], null, 'A gray metal hallway<br>Core exhaust pipes run along the walls. A severed foot is lodged in between two pipes.'),
		new Room(false, [Items.potion], null, 'A gray metal hallway<br>Core exhaust pipes run along the walls.'),
		new Room(false, [], null, 'A gray metal hallway<br>Core exhaust pipes run along the walls. It smells of spoiled milk.'),
		new Room(false, [], randomMemberOf(Enemies.hard), 'A gray metal hallway<br>Core exhaust pipes run along the walls.'),
		new Room(false, [], null, 'A gray metal hallway<br>Core exhaust pipes run along the walls.<br>A green glow is leaking under the door from the room to the east.'),
		new Room(true, [], null, 'The door to the north has a sign: \'Central Drive Core Chamber\'.<br>A green glow emanates from under the door and reflects around the room.'),
		new Room(false, [], null, 'A gray metal hallway<br>Core exhaust pipes run along the walls.<br><br>A green glow is leaking under the door from the room to the west.'),
		new Room(false, [], null, 'A gray metal hallway<br>Core exhaust pipes run along the walls.'),
		new Room(false, [], null, 'A gray metal hallway<br>Core exhaust pipes run along the walls.'),
		new Room(false, [Items.potion], null, 'A gray metal hallway<br>Core exhaust pipes run along the walls. A bloody lyn-saber was snapped in half and left on the floor'),
		new Room(false, [], null, 'A gray metal hallway<br>Core exhaust pipes run along the walls.'),
	],
	...
	[
		...
		null,
		null,
		new Room(false, [], null, 'A narrow maintenance hallway<br>A small porthole on the west wall provides a scenic view of a passing nebula.'),
		null,
		null,
		null,
		new Room(false, [], randomMemberOf(Enemies.hard), 'A narrow maintenance hallway<br>The walls have been smeared with someone\'s surplus blood.'),
		null,
		null,
		null,
	],
	...
	[
		...
		new Room(false, [], randomMemberOf(Enemies.tough), 'The floor is covered in strewn human bones and viscera<br>Horned helmets are piled against the north wall, though most have been broken.'),
		new Room(true, [], null, 'A central maintenance room<br>Doors to the west and east provide access to the engine sector.'),
		new Room(false, [], randomMemberOf(Enemies.tough), 'This room is spotless<br>Someone even took the time to clean the ceilings.'),
		new Room(false, [Items.potion], null, 'A narrow maintenance hallway'),
		null,
		new Room(true, [Items.statues.caeven], null, 'Capt. Ormskaeg\'s private room<br>The Captain\'s belongings have been thrown onto the floor.'),
		new Room(false, [], randomMemberOf(Enemies.hard), 'Sleeping quarters, bunks are pushed against the north and east walls.'),
	],
	
	[
		new Room(false, [Items.potion], null, 'Sleeping quarters, the west and east walls are lined with bunks<br>Blood on the floor is evidence of a recent fight.'),
		null,
		...
		null,
		null,
		new Room(false, [Items.keys.iron], null, 'A small alcove filled with shelves<br>The shelves are mostly filled with salted fish.'),
		null,
	...
	[
		...
		null,
		new Room(false, [], randomMemberOf(Enemies.medium), 'Stepping closer to the center of the room brings the sensation of hundreds of screaming voices gasping their final breaths.<br>Gnarsty.'),
		null,
	],
	...
	[
		...
		new Room(false, [Items.potion], null, 'A tall, airy chamber. The ceiling has a stained glass cupola.<br>Apparently the captain stole it off some Neo-British station way back.'),
	...
	[
		...
		null,
		new Room(false, [Items.keys.trophy], null, 'The hallway is lined with trophy cases. There are some trophies too.<br>\'Norse Soccer Champions 20XX-4\', huh.'),
	...
	[
		...
		null,
		new Room(false, [], randomMemberOf(Enemies.tough), 'The wall panelling is spread around the room.<br>The pipes have been pulled out of the wall and are spraying superheated steam in the air.'),
		new Room(true, [], null, 'A security room. It was locked down prety tight until you found the key.<br>Someone already emptied the weapon cabinet.'),
		new Room(false, [], null, 'A nice snack room, the vending machines are fully stocked.<br>A bulkhead automatically sealed off access to the west.'),
		...
		new Room(false, [], randomMemberOf(Enemies.easy), 'A bay window reveals a beautiful space vista. Someone taped a chore list to the window.<br>It\'s Sveinbjorn\'s day to do the dishes, he probably won\'t though.'),
	],
	
	[
		new Room(false, [Items.playerWeapons.bjoernkrammer], null, 'The bow of the ship<br>A large window to the south provides a view of passing asteroids.'),
		new Room(false, [Items.potion], null, 'The bow of the ship<br>The bulkhead to the south has sealed off access to the bridge.<br>The room is full of comfortable chairs and piles of half-salted fish.'),
		new Room(false, [], randomMemberOf(Enemies.easy), 'The bow of the ship<br>A human skeleton is lounging on a couch in front of the window.<br>The large window provides a nice view of the star the ship is orbiting. Is that the bridge floating over there?.'),
		new Room(false, [], null, 'The bow of the ship<br>Normally one could see the bridge through the southern window, but it seems to be missing.'),
		null,
		new Room(false, [], null, 'The secondary bow airlock is to the west, but it has been automatically sealed.'),
		null,
		new Room(false, [Items.playerWeapons.sjoraeningi], null, 'The main bow airlock is to east, but it has been automatically sealed.<br>Half salted fish litters the floor<br>You can see a distant gas giant through the large window to the south.'),
		null,
		null,
		null,
	],
